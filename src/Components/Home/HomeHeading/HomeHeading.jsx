...
export default function HomeHeading() {
  ...
  return (
    <section className='homeCaption position-relative px-3 px-lg-5  pt-5 py-lg-0 rounded-4 d-flex flex-column flex-lg-row justify-content-lg-between align-items-center'>
