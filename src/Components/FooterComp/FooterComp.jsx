         ...
         <div className='d-flex align-items-center flex-column footerBorderBottom flex-md-row justify-content-md-between'>
          <div className='text-center text-md-start imageBorderBottom p-2 py-4 '>
            ...
            <div className='d-flex flex-column p-3 align-items-center flex-md-row links'>
                  ...
                  <Link className="text-uppercase  text-white text-decoration-none p-2" aria-current="locations page" to="/Locations">locations</Link>
                  <Link className="text-uppercase  text-white text-decoration-none p-2" aria-current="contact page" to="/Contact">contact</Link>
            </div>
         </div>
         <div className='d-flex flex-md-row justify-content-md-between py-md-5 flex-column'>
            <div className='d-flex flex-column textFooter align-items-center flex-md-row justify-content-md-between px-2 mb-3 mb-md-0'>
                ...
                <div className='text-center text-md-start ps-md-5'>
                      ...
                      <p className='mb-2 fw-semibold small'>P : +1 253-863-8967</p>
                      <p className='mb-2 fw-semibold small'>M : contact@designo.co</p>
                </div>
            </div>
